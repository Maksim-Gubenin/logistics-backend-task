...
<img width="732" height="418" alt="Диаграмма БД drawio" src="https://github.com/user-attachments/assets/fbc0dfb4-8ad0-4dc0-8879-eb629d3bdf4e" />
...
Полный код с комментариями доступен в файле [solution.sql](./solution.sql).
